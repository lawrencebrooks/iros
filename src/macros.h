...
#define DEBUG_LEVEL_LOCATION DEBUG_LEVEL_BEGINNING
...
#define ENEMY_ICICLE 2
#define ENEMY_FIREBALL 3
#define ENEMY_SPORE 4
#define ENEMY_ACID 5
#define ENEMY_SUNRAY 6
#define ENEMY_TANK 7
#define ENEMY_DRONE 8
#define ENEMY_GLOBE 9
